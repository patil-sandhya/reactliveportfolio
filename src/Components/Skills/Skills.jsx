...
import bootstrpImg from "./bootstrap.jpg"
const Skills = () => {
  return (
    <div className={Styles.Skills} id="skills">
        ...
        <Box  w={{base:"100%",sm:"100%",md:"95%",lg:"95%"}} margin={"auto"} p={5} mt={{base:"50px",sm:"50px",md:"50px",lg:"40px"}}  h="auto" textAlign="center" display={"flex"} justifyContent={"center"} >
          ...
          <Grid templateColumns={{base:"repeat(2,1fr)",sm:"repeat(2,1fr)",md:"repeat(3,1fr)",lg:"repeat(4,1fr)"}} gap={{base:"20px",sm:"35px",md:"65px",lg:"65px"}}>
            ...
            {/* HTML 5 */}
          <Box border={"1px solid white"} borderRadius="15px" p={{base:"3",sm:"5",md:"7",lg:"5"}} display="flex" flexDirection="column" justifyContent="center" alignItems="center" _hover={{bgColor:"#fa69ae",border:"none"}} >
          <Image w={{base:"60px",sm:"70px",md:"80px",lg:"100px"}}   mt="10px" src='https://chiranjeev-thapliyal.vercel.app/svg/html-5.svg' alt='html5' />
          <Text textStyle="AboutPara" textAlign={"center"} fontWeight="bold"> HTML 5 </Text>
          </Box>
          ...
          <Box border={"1px solid white"} borderRadius="15px" p={{base:"3",sm:"5",md:"7",lg:"5"}}  display="flex" flexDirection="column" justifyContent="center" alignItems="center" _hover={{bgColor:"#fa69ae",border:"none"}}>
          <Image w={{sm:"60px",md:"80px",lg:"100px"}} style={{borderRadius:"5px"}} mt="10px" src={bootstrpImg} alt='' />
          <Text textStyle="AboutPara" textAlign={"center"}>Bootstrap</Text>
          </Box>
          

            {/* NPM 
          <Box border={"1px solid white"} borderRadius="15px"  display="flex" flexDirection="column" justifyContent="center" alignItems="center" _hover={{bgColor:"#fa69ae",border:"none"}}>
          ...
          <Text textStyle="AboutPara" textAlign={"center"}></Text>
          </Box>
