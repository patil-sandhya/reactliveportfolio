  ...
  return (
    <div className={Styles.Stats}>
        <Box w="80%" margin={"auto"} p={7} h={{sm:"auto",md:"auto",lg:"auto"}} textAlign={{base:"center",sm:"center",md:"center",lg:"initial"}}>
            ...
            <GitHubCalendar username="patil-sandhya" />
            </Box>
            ...
            <Image src='https://github-readme-stats.vercel.app/api?username=patil-sandhya&show_icons=true&theme=radical' w={"60%"} alt='' />
            <Image src="https://github-readme-stats.vercel.app/api/top-langs/?username=patil-sandhya&langs_count=8" w={"60%"} alt=''/>
            </Flex>
            </Box>
