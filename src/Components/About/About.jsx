            ...
            <Flex direction={{base:"column",sm:"column",md:"column",lg:"row"}} justifyContent="space-around" alignItems="center">
                ...
                <Box w={{base:"90%",sm:"90%",md:"90%",lg:"65%"}}>
                    ...
                    <UnorderedList>
                      ...
                      <ListItem>
                      <Text textStyle="AboutPara">Outside of the tech world,  I'm also quite passionate about discovering new places through traveling, which helps me stay creative and inspired. If you're looking for a full-stack web developer who is passionate, enthusiastic, and always willing to learn, I would love to connect and discuss your projects. </Text>
                      </ListItem>
                    </UnorderedList>
